...
public class Poruka {
    ...
    public Poruka(String id, Date poslano, String salje, String predmet, String vrsta, String sadrzajPoruke, int velicina, int brojPrivitaka, Flags zastavice, List<PrivitakPoruke> privitciPoruke, boolean brisati, boolean procitano) {
        this.id = id;
