 ...
 */
package org.foi.nwtis.davmoslav.filter;
 ...
 * @author Davor
 */
public class DnevnikKorisnickihZahtjeva implements Filter {
    ...
    public DnevnikKorisnickihZahtjeva() {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            log("DnevnikKorisnickihZahtjeva:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("DnevnikKorisnickihZahtjeva:DoAfterProcessing");
        }
        String url = ((HttpServletRequest) request).getServletPath();
        Connection conn = null;
        Statement stmt = null;

        String sql = "INSERT INTO davmoslav_korisnicki_zahtjevi (zahtjev, vrijeme_obrade, vrijeme) VALUES ('"
                + url + "','" + (System.currentTimeMillis() - pocetnoVrijeme) + "','"
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (debug) {
            log("DnevnikKorisnickihZahtjeva:doFilter()");
        }
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("DnevnikKorisnickihZahtjeva:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("DnevnikKorisnickihZahtjeva()");
        }
        StringBuffer sb = new StringBuffer("DnevnikKorisnickihZahtjeva(");
